...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/DigitalRelease'),
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/DigitalReleaseGroup')
                  ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ ᴏᴜʀ ᴛɢ ᴄʜᴀɴɴᴇʟ', url="https://t.me/DigitalRelease")
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
